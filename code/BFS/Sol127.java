...
public class Sol127 {
    ...
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        if(wordSet.size()==0 || !wordList.contains(endWord) || wordList.get(0).length()!=beginWord.length()) return 0;
    ...
    private boolean changeWordEveryOneLetter(String currentWord,String endWord,
        ...
        for (int i = 0; i < endWord.length(); i++) {
            ...
            //每次将遍历到的单词的某一位替换为26个字母中的一个，先判断字典中是否有这个单词，若无，先恢复这个单词，再返回false，
            // 若有，看是否和endWord匹配
            for (char k = 'a'; k <= 'z'; k++) {
     ...
     * @return
     */
    private boolean changeWordEveryOneLetter1(String word, Set<String> endVisited,
                                             Set<String> visited,
                                             Set<String> wordSet,
